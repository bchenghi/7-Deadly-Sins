...
public class ArmorBoostLvl3 : Skill, IUsable
{
    ...
    IEnumerator IncreaseArmorRountine()
    {
        ...
        PlayerManager.instance.player.GetComponent<EffectHandler>().UseEffect(5, 5);
        PlayerManager.instance.player.GetComponent<EffectHandler>().effectNum = 5;
    ...
    {
        base.Start();
        Description = "Increases player's armor by 30 but decreases walkspeed by 1 and runspeed by 3 for 5 seconds";
        MaxSkillLevel = 3;
